...
["14 AAG Persistence", "Save current state", FUNC(moduleSave)] call zen_custom_modules_fnc_register;
...
["14 AAG Persistence", "Reset save", FUNC(moduleResetSave)] call zen_custom_modules_fnc_register;
